...
_P5_SPEECH_SELECTOR_ROW = (
    "child_node",
    r"^uses the exact 1500 ms silence boundary and replaces one live timer on results and speech end$",
    1,
    (10,),
)
...
def test_literal_p5_selector_oracle_has_explicit_p6_timeout_replacements():
    ...
    assert _P5_SPEECH_SELECTOR_ROW in p5_rows
    assert _P5_SPEECH_SELECTOR_ROW not in actual_rows
    assert _P6_EXPLICIT_SPEECH_SELECTOR_ROW in actual_rows
