...
child_node | ^explicit stop stays pending without an onend and only onend settles the transcript$ | 1 | 13,14
...
browser | ^test_tts_cold_start_uses_reachable_fifteen_second_fallback\[(1024x576|1280x720)\]$ | 2 | 10,14
...
browser | ^test_tts_11000ms_cold_start_uses_same_request_audio_path\[(1024x576|1280x720)\]$ | 2 | 10,14
